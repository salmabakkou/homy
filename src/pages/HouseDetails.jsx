    ...
    <div className="bg-[#FDFCF9] min-h-screen pb-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
        ...
        <div className="grid lg:grid-cols-4 gap-4 mb-10 overflow-hidden">
          ...
          <div className="flex lg:flex-col gap-4 overflow-x-auto lg:overflow-y-auto pb-2 lg:pb-0 scrollbar-none h-[100px] lg:h-[550px]">
            {allImages.map((img, idx) => (
              <div
                key={idx}
                onClick={() => setCurrentIdx(idx)}
                className={`relative cursor-pointer shrink-0 w-32 lg:w-full h-full lg:h-32 rounded-2xl overflow-hidden border-2 transition-all duration-300 ${currentIdx === idx ? 'border-[#D4AF37] shadow-lg' : 'border-transparent opacity-50 hover:opacity-100 scale-95'}`}
              >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm mb-12">
          ...
          <div className="flex items-center gap-6 md:gap-12">
            <div className="flex items-center gap-3">
              <FaBed className="text-[#C3091C]" size={20} />
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Chambres</span>
                <span className="font-serif font-bold text-lg">{house.rooms}</span>
              </div>
            </div>
            <div className="w-[1px] h-10 bg-gray-100" />
            <div className="flex items-center gap-3">
              <FaBath className="text-[#C3091C]" size={18} />
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Bains</span>
                <span className="font-serif font-bold text-lg">{house.bathrooms}</span>
              </div>
            </div>
            <div className="w-[1px] h-10 bg-gray-100" />
            <div className="flex items-center gap-3">
              <FiMaximize className="text-[#C3091C]" size={18} />
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Surface</span>
                <span className="font-serif font-bold text-lg">{house.surface} m²</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-2 w-full md:w-auto">
            ...
            <div className="flex items-baseline gap-2 mt-1">
              ...
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">MAD</span>
            </div>
          </div>
        </div>
